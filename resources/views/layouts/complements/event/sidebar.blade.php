<div class="sidebar" style="display: flex; flex-direction: column; align-items: flex-start;">
    <a href="{{ url('/events') }}" class="sidebar-link" style="margin-bottom: 5px;">Ver Eventos</a>
    ...
    <a href="{{ url('/events/delete') }}" class="sidebar-link" style="margin-bottom: 5px;">Eliminar Evento</a>
